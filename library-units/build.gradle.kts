/**
 * AppDimens KMP — Units strategy module.
 *
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-units", libraryVersion)

    pom {
        name.set("AppDimens KMP — Units")
        description.set("Units strategy: physical units (mm, cm, in, pt, px) computed from real device density.")
