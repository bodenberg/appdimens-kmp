################################################################################
# AppDimens Dynamic satellite — appdimens-kmp-units — proguard-rules.pro
#
...
-keep public class com.appdimens.kmp.code.units.** { public protected *; }
-keep public class com.appdimens.kmp.compose.units.** { public protected *; }
