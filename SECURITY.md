...
Please report security issues privately via GitHub Security Advisories on [bodenberg/appdimens-kmp](https://github.com/bodenberg/appdimens-kmp), or email the maintainer listed in the Maven POM (`jean.bodenberg2@outlook.com`).
