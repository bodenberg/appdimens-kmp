/**
 * AppDimens KMP — Logarithmic strategy module.
 *
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-logarithmic", libraryVersion)

    pom {
        name.set("AppDimens KMP — Logarithmic")
        description.set("Logarithmic strategy: logarithmic scaling that stays readable across very different screens.")
