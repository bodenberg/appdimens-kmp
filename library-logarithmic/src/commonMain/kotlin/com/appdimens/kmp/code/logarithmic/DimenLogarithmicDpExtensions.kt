 ...
 */
private fun Number.fastLogarithmicPx(context: AppDimensContext, qualifier: DpQualifier, applyAspectRatio: Boolean): Float {
...
fun Number.logsdp(context: AppDimensContext): Float = fastLogarithmicPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = false)
fun Number.logsdpa(context: AppDimensContext): Float = fastLogarithmicPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = true)
fun Number.logsdpi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true)
fun Number.logsdpia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logsdpPh(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.logsdpPha(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.logsdpPhi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.logsdpPhia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logsdpLh(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.logsdpLha(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.logsdpLhi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.logsdpLhia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logsdpPw(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.logsdpPwa(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.logsdpPwi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.logsdpPwia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logsdpLw(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.logsdpLwa(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.logsdpLwi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.logsdpLwia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.loghdp(context: AppDimensContext): Float = fastLogarithmicPx(context, DpQualifier.HEIGHT, applyAspectRatio = false)
fun Number.loghdpa(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, applyAspectRatio = true)
fun Number.loghdpi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true)
fun Number.loghdpia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.loghdpLw(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.loghdpLwa(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.loghdpLwi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.loghdpLwia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.loghdpPw(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.loghdpPwa(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.loghdpPwi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.loghdpPwia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logwdp(context: AppDimensContext): Float = fastLogarithmicPx(context, DpQualifier.WIDTH, applyAspectRatio = false)
fun Number.logwdpa(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, applyAspectRatio = true)
fun Number.logwdpi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true)
fun Number.logwdpia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logwdpLh(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.logwdpLha(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.logwdpLhi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.logwdpLhia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logwdpPh(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.logwdpPha(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.logwdpPhi(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.logwdpPhia(context: AppDimensContext): Float = this.toDynamicLogarithmicPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.logsdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.loghdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.logwdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
 ...
 */
fun Number.logsdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.loghdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.logwdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
