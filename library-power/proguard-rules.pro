################################################################################
# AppDimens Dynamic satellite — appdimens-kmp-power — proguard-rules.pro
#
...
-keep public class com.appdimens.kmp.code.power.** { public protected *; }
-keep public class com.appdimens.kmp.compose.power.** { public protected *; }
