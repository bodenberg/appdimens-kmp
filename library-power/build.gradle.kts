/**
 * AppDimens KMP — Power strategy module.
 *
...
kotlin {
    android {
        namespace = "com.appdimens.kmp.power"
        optimization {
            minify = true
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-power", libraryVersion)

    pom {
        name.set("AppDimens KMP — Power")
        description.set("Power strategy: power-law scaling for aggressive growth on large screens.")
