 ...
 * GIT: https://github.com/bodenberg/appdimens-kmp.git
 *
 ...
 * `appdimens-kmp` artifact. Package segment is the last component of
 * `com.appdimens.kmp.compose.<segment>` / `code.<segment>`.
 *
...
object MissingModule {
    ...
    const val PRINCIPAL_ARTIFACT: String = "appdimens-kmp"
    const val BOM_ARTIFACT: String = "appdimens-kmp-bom"

    /** EN package segment → Maven artifactId. PT segmento → artifactId. */
    val ARTIFACT_BY_PACKAGE: Map<String, String> = mapOf(
        "auto" to "appdimens-kmp-auto",
        "density" to "appdimens-kmp-density",
        "diagonal" to "appdimens-kmp-diagonal",
        "fill" to "appdimens-kmp-fill",
        "fit" to "appdimens-kmp-fit",
        "fluid" to "appdimens-kmp-fluid",
        "interpolated" to "appdimens-kmp-interpolated",
        "logarithmic" to "appdimens-kmp-logarithmic",
        "percent" to "appdimens-kmp-percent",
        "perimeter" to "appdimens-kmp-perimeter",
        "power" to "appdimens-kmp-power",
        "resize" to "appdimens-kmp-resize",
        "units" to "appdimens-kmp-units",
    ...
    fun requireArtifact(
        ...
        version: String,
        importFqName: String = "com.appdimens.kmp.*.$packageSegment",
    ) {
