 ...
 *    [DimenCache.isEnabled.load()] — inverter DEFAULT, ignoreMultiWindows=false,
...
fun Number.dsdp(context: AppDimensContext): Float = fastDensityPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = false)
fun Number.dsdpa(context: AppDimensContext): Float = fastDensityPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = true)
fun Number.dsdpi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true)
fun Number.dsdpia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dsdpPh(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.dsdpPha(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.dsdpPhi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.dsdpPhia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dsdpLh(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.dsdpLha(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.dsdpLhi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.dsdpLhia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dsdpPw(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.dsdpPwa(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.dsdpPwi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.dsdpPwia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dsdpLw(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.dsdpLwa(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.dsdpLwi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.dsdpLwia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dhdp(context: AppDimensContext): Float = fastDensityPx(context, DpQualifier.HEIGHT, applyAspectRatio = false)
fun Number.dhdpa(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, applyAspectRatio = true)
fun Number.dhdpi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true)
fun Number.dhdpia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dhdpLw(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.dhdpLwa(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.dhdpLwi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.dhdpLwia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dhdpPw(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.dhdpPwa(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.dhdpPwi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.dhdpPwia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dwdp(context: AppDimensContext): Float = fastDensityPx(context, DpQualifier.WIDTH, applyAspectRatio = false)
fun Number.dwdpa(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, applyAspectRatio = true)
fun Number.dwdpi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true)
fun Number.dwdpia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dwdpLh(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.dwdpLha(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.dwdpLhi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.dwdpLhia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dwdpPh(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.dwdpPha(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.dwdpPhi(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.dwdpPhia(context: AppDimensContext): Float = this.toDynamicDensityPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dsdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.dhdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.dwdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
 ...
 */
fun Number.dsdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.dhdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.dwdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
