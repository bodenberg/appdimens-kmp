/**
 * AppDimens KMP — Density strategy module.
 *
...
kotlin {
    android {
        namespace = "com.appdimens.kmp.density"
        optimization {
            minify = true
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-density", libraryVersion)

    pom {
        name.set("AppDimens KMP — Density")
        description.set("Density strategy: raw density-based scaling (wdp-like) for pixel-perfect layouts.")
