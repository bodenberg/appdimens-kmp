/**
 * AppDimens KMP — Fluid strategy module.
 *
...
kotlin {
    android {
        namespace = "com.appdimens.kmp.fluid"
        optimization {
            minify = true
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-fluid", libraryVersion)

    pom {
        name.set("AppDimens KMP — Fluid")
        description.set("Fluid strategy: fluid interpolation between breakpoint-based sizes.")
