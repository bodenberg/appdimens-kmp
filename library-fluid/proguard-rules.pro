################################################################################
# AppDimens Dynamic satellite — appdimens-kmp-fluid — proguard-rules.pro
#
...
-keep public class com.appdimens.kmp.code.fluid.** { public protected *; }
-keep public class com.appdimens.kmp.compose.fluid.** { public protected *; }
