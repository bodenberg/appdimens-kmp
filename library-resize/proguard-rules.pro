################################################################################
# AppDimens Dynamic satellite — appdimens-kmp-resize — proguard-rules.pro
#
...
-keep public class com.appdimens.kmp.code.resize.** { public protected *; }
-keep public class com.appdimens.kmp.compose.resize.** { public protected *; }
