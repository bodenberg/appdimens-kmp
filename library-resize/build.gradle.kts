/**
 * AppDimens KMP — Resize strategy module.
 *
...
kotlin {
    android {
        namespace = "com.appdimens.kmp.resize"
        optimization {
            minify = true
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-resize", libraryVersion)

    pom {
        name.set("AppDimens KMP — Resize")
        description.set("Resize strategy: responsive resize of text and spacing between breakpoints.")
