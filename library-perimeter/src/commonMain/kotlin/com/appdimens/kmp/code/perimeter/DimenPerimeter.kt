...
class DimenPerimeter private constructor(
     ...
     */
    fun prsdpPrhdpPrwdpPx(context: AppDimensContext): Triple<Float, Float, Float> {
        val configuration = context.configuration
        val currentUiModeType = DimenCache.getCachedUiModeType(context)
    ...
    fun prsdp(context: AppDimensContext): Float = px(context, DpQualifier.SMALL_WIDTH)
    fun prhdp(context: AppDimensContext): Float = px(context, DpQualifier.HEIGHT)
    fun prwdp(context: AppDimensContext): Float = px(context, DpQualifier.WIDTH)

    /** EN Get the resolved value in DP (as Float). */
    fun prsdpBase(context: AppDimensContext): Float = resolveDp(context, DpQualifier.SMALL_WIDTH)
    fun prhdpBase(context: AppDimensContext): Float = resolveDp(context, DpQualifier.HEIGHT)
    fun prwdpBase(context: AppDimensContext): Float = resolveDp(context, DpQualifier.WIDTH)
}