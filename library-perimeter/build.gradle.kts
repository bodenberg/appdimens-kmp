/**
 * AppDimens KMP — Perimeter strategy module.
 *
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-perimeter", libraryVersion)

    pom {
        name.set("AppDimens KMP — Perimeter")
        description.set("Perimeter strategy: scaling based on the screen perimeter in dp.")
