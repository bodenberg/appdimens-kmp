################################################################################
# AppDimens Dynamic satellite — appdimens-kmp-perimeter — proguard-rules.pro
#
...
-keep public class com.appdimens.kmp.code.perimeter.** { public protected *; }
-keep public class com.appdimens.kmp.compose.perimeter.** { public protected *; }
