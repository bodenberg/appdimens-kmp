/**
 * AppDimens KMP — Diagonal strategy module.
 *
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-diagonal", libraryVersion)

    pom {
        name.set("AppDimens KMP — Diagonal")
        description.set("Diagonal strategy: scaling based on the screen diagonal in inches.")
