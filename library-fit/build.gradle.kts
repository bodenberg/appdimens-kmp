/**
 * AppDimens KMP — Fit strategy module.
 *
...
kotlin {
    android {
        namespace = "com.appdimens.kmp.fit"
        optimization {
            minify = true
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-fit", libraryVersion)

    pom {
        name.set("AppDimens KMP — Fit")
        description.set("Fit strategy: fits content into the available space while preserving proportions.")
