################################################################################
# AppDimens Dynamic satellite — appdimens-kmp-fit — proguard-rules.pro
#
...
-keep public class com.appdimens.kmp.code.fit.** { public protected *; }
-keep public class com.appdimens.kmp.compose.fit.** { public protected *; }
