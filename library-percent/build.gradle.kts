/**
 * AppDimens KMP — Percent strategy module.
 *
...
kotlin {
    android {
        namespace = "com.appdimens.kmp.percent"
        optimization {
            minify = true
...
mavenPublishing {
    coordinates("io.github.bodenberg", "appdimens-kmp-percent", libraryVersion)

    pom {
        name.set("AppDimens KMP — Percent")
        description.set("Percent strategy: percent / screen-fraction scaling (psdp, space* / code.percent).")
