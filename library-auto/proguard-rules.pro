################################################################################
# AppDimens Dynamic satellite — appdimens-kmp-auto — proguard-rules.pro
#
...
-keep public class com.appdimens.kmp.code.auto.** { public protected *; }
-keep public class com.appdimens.kmp.compose.auto.** { public protected *; }
