 ...
 */
private fun Number.fastAutoPx(context: AppDimensContext, qualifier: DpQualifier, applyAspectRatio: Boolean): Float {
...
fun Number.asdp(context: AppDimensContext): Float = fastAutoPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = false)
fun Number.asdpa(context: AppDimensContext): Float = fastAutoPx(context, DpQualifier.SMALL_WIDTH, applyAspectRatio = true)
fun Number.asdpi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true)
fun Number.asdpia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.asdpPh(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.asdpPha(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.asdpPhi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.asdpPhia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.asdpLh(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.asdpLha(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.asdpLhi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.asdpLhia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.asdpPw(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.asdpPwa(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.asdpPwi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.asdpPwia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.asdpLw(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.asdpLwa(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.asdpLwi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.asdpLwia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.ahdp(context: AppDimensContext): Float = fastAutoPx(context, DpQualifier.HEIGHT, applyAspectRatio = false)
fun Number.ahdpa(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, applyAspectRatio = true)
fun Number.ahdpi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true)
fun Number.ahdpia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.ahdpLw(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.ahdpLwa(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.ahdpLwi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.ahdpLwia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.ahdpPw(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.ahdpPwa(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.ahdpPwi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.ahdpPwia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.awdp(context: AppDimensContext): Float = fastAutoPx(context, DpQualifier.WIDTH, applyAspectRatio = false)
fun Number.awdpa(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, applyAspectRatio = true)
fun Number.awdpi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true)
fun Number.awdpia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.awdpLh(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.awdpLha(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.awdpLhi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.awdpLhia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.awdpPh(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.awdpPha(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.awdpPhi(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.awdpPhia(context: AppDimensContext): Float = this.toDynamicAutoPx(context, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.asdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.ahdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.awdpQualifier(context: AppDimensContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
 ...
 */
fun Number.asdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.ahdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.awdpScreen(context: AppDimensContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val configuration = context.configuration
    val currentUiModeType = DimenCache.getCachedUiModeType(context)
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, configuration) >= qualifierValue.toFloat()
